<?php
    ...
    $payment->addParameter()->withArray(['notificationURL', 'http://localhost/erp/pagseguro-php-sdk-master/public/Notifications/transactionListener.php']);

    $payment->setRedirectUrl("http://www.federalsistemas.com.br");
    $payment->setNotificationUrl("http://localhost/erp/pagseguro-php-sdk-master/public/Notifications/transactionListener.php");
