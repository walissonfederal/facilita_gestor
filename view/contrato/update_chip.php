    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".contrato_chip_cliente_assinou").val(data_return[0].contrato_chip_cliente_assinou);
                $(".contrato_chip_data_final").val(data_return[0].contrato_chip_data_final);
                $(".contrato_chip_data_inicial").val(data_return[0].contrato_chip_data_inicial);
                $(".contrato_chip_id_contato").val(data_return[0].contrato_chip_id_contato);
                buscar_contato();
                $(".contrato_chip_status").val(data_return[0].contrato_chip_status);
            }
        });
    });
