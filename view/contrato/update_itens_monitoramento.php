                    ...
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                ...
                                <a href="javascript::" onclick="carrega_pagina('contrato', 'itens_monitoramento.php?id=<?=$_GET['id_contrato'];?>');" class="btn btn-primary">Voltar</a>
                            </h3>
                        </div>
...
<script>
    function update(){
        ...
        var acao = "&acao=update_itens&id=<?=$_GET['id'];?>&id_contrato=<?=$_GET['id_contrato'];?>";
    ...
    $(function(){
        var acao = "acao=load_update_itens&id=<?=$_GET['id'];?>";
        $.ajax({
            type: 'POST',
            url: "_controller/_contrato_monitoramento.php",
            data: acao,
            ...
            success: function (data) {
                ...
                if(data_return.type === 'error'){
                    ...
                    setTimeout(function(){
                        $("#_modal").modal('hide');
                        carrega_pagina('contrato', 'itens_monitoramento.php?id=<?=$_GET['id'];?>');
                    }, 3000);
                }else{
                    $(".contrato_monitoramento_itens_quantidade").val(data_return[0].contrato_monitoramento_itens_quantidade);
                    $(".contrato_monitoramento_itens_descricao").val(data_return[0].contrato_monitoramento_itens_descricao);
                    $(".contrato_monitoramento_itens_data").val(data_return[0].contrato_monitoramento_itens_data);
                    $(".contrato_monitoramento_itens_valor_unitario").val(data_return[0].contrato_monitoramento_itens_valor_unitario);
                    $(".contrato_monitoramento_itens_valor_total").val(data_return[0].contrato_monitoramento_itens_valor_total);
                }
            }
        });
    });
