                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="form-group col-lg-1">
                                            <label>ID User</label>
                                            <input type="text" class="form-control search_nome_id_user" name="pedido_id_user" onblur="buscar_contato();"/>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-2">
                                            <label>Valor</label>
                                            <input type="text" class="form-control" name="pedido_valor" id="valor_1"/>
                                        </div>
                                        <div class="form-group col-lg-2">
                                            <label>Data Vencimento</label>
                                            <input type="date" class="form-control" name="pedido_data_vencimento" />
                                        </div>
                                    </div>
                                    <div class="row">
