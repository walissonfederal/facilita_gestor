                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="form-group col-lg-9">
                                            ...
                                            <input type="text" class="form-control nivel_descricao" name="nivel_descricao"/>
                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label>Status</label>
                                            <select class="form-control nivel_status" name="nivel_status">
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                load_out();
                var data_return = jQuery.parseJSON(data);
                $(".nivel_descricao").val(data_return[0].nivel_descricao);
                $(".nivel_status").val(data_return[0].nivel_status);
            }
        });
    });
</script>