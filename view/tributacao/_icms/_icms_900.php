<div class="row">
    ...
    <div class="form-group col-lg-2">
        <label>Alíq. cálc. crédito (%)</label>
        <input type="text" class="form-control tributacao_icms_aliquota_calc_credito" name="tributacao_icms_aliquota_calc_credito" id="icms_valor_3"/>
    </div>
</div>
<div class="row">
    ...
    <div class="form-group col-lg-2">
        ...
        <input type="text" class="form-control tributacao_icms_margem_valor_add" name="tributacao_icms_margem_valor_add" id="icms_valor_4"/>
    </div>
    <div class="form-group col-lg-2">
        <label>Redução Base Calc ST (%)</label>
        <input type="text" class="form-control tributacao_icms_reducao_base_calc_st" name="tributacao_icms_reducao_base_calc_st" id="icms_valor_5"/>
    </div>
    <div class="form-group col-lg-2">
        <label>Preço unit. Pauta ST (R$)</label>
        <input type="text" class="form-control tributacao_icms_preco_un_pauta_st" name="tributacao_icms_preco_un_pauta_st" id="icms_valor_6"/>
    </div>
    <div class="form-group col-lg-2">
        <label>Alíq. do ICMS ST (%)</label>
        <input type="text" class="form-control tributacao_icms_aliquota_icms_st" name="tributacao_icms_aliquota_icms_st" id="icms_valor_7"/>
    </div>
</div>
<script>
