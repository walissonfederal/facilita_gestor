                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select name="contato_monitoramento" class="form-control contato_monitoramento">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select name="contato_rastreamento" class="form-control contato_rastreamento">
                                                <option value="0">NÃO</option>
                                                <option value="1">SIM</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select name="contato_telefonia" class="form-control contato_telefonia">
                                                <option value="0">NÃO</option>
                                                <option value="1">SIM</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" onkeyup="somenteNumeros(this);" name="contato_cpf_cnpj" class="form-control contato_cpf_cnpj"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
										...
										<div class="form-group col-lg-3">
                                            ...
                                            <select name="contato_subcliente" class="form-control contato_subcliente">
                                                <option value="0">Não</option>
                                                <option value="1">Sim</option>
                                            </select>
                                        </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data_return.length === '0'){
                    ...
                    $(".contato_bairro").val(data_return[0].contato_bairro);
                    $(".contato_cep").val(data_return[0].contato_cep);
                    $(".contato_cidade").val(data_return[0].contato_cidade);
                    $(".contato_cidade_ibge").val(data_return[0].contato_cidade_ibge);
                    $(".contato_complemento").val(data_return[0].contato_complemento);
                    $(".contato_cpf_cnpj").val(data_return[0].contato_cpf_cnpj);
                    $(".contato_descricao_regiao").val();
                    $(".contato_descricao_rota").val();
                    $(".contato_descricao_tipo_contato").val();
                    $(".contato_email_alternativo").val(data_return[0].contato_email_alternativo);
                    $(".contato_email").val(data_return[0].contato_email);
                    $(".contato_endereco").val(data_return[0].contato_endereco);
                    $(".contato_estado").val(data_return[0].contato_estado);
                    $(".contato_id_regiao").val(data_return[0].contato_id_regiao);
                    $(".contato_id_rota").val(data_return[0].contato_id_rota);
                    $(".contato_id_tipo_contato").val(data_return[0].contato_id_tipo_contato);
                    $(".contato_ie_rg").val(data_return[0].contato_ie_rg);
                    $(".contato_isuframa").val(data_return[0].contato_isuframa);
                    $(".contato_nome_fantasia").val(data_return[0].contato_nome_fantasia);
                    $(".contato_nome_razao").val(data_return[0].contato_nome_razao);
                    $(".contato_numero").val(data_return[0].contato_numero);
                    $(".contato_telefone").val(data_return[0].contato_telefone);
                    $(".contato_celular").val(data_return[0].contato_celular);
                    $(".contato_obs").val(data_return[0].contato_obs);
                    $(".contato_monitoramento").val(data_return[0].contato_monitoramento);
                    $(".contato_rastreamento").val(data_return[0].contato_rastreamento);
                    $(".contato_telefonia").val(data_return[0].contato_telefonia);
                    $(".contato_id_associado").val(data_return[0].contato_id_associado);
                    $(".contato_protestado").val(data_return[0].contato_protestado);
                    $(".contato_data_protestado").val(data_return[0].contato_data_protestado);
					$(".contato_subcliente").val(data_return[0].contato_subcliente);
					$(".contato_rastrek").val(data_return[0].contato_rastrek);
                }
            }
        });
    });
