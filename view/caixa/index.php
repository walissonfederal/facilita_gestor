                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Caixa
                                <a href="javascript::" onclick="carrega_pagina('caixa', 'create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
...
<script>
    ...
    $("#load_caixa").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_caixa.php",
        ...
        columns: [
            {
                formatter: updateIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    carrega_pagina('caixa', 'update.php?id='+data.caixa_id);
                }
            },
            {title: "ID", field: "caixa_id", sorter: "int", width: 200},
            {title: "Descrição", field: "caixa_descricao", sorter: "string"},
            {title: "Status", field: "caixa_status_view", sorter: "string"}
        ]
    });
