                        ...
                        <div class="box-content">
                            <div class="row">
                                <div class="form-group col-lg-12" align="right">
                                    ...
                                    <a href="javascript::" onclick="carrega_pagina('pessoa', 'index.php')" class="btn btn-danger">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function gerar_excel(){
        window.open('_controller/_pessoa.php?acao=gerar_excel', '_blank');
    }
    function gerar_pdf(){
        window.open('_reports/_pessoa/report.php', '_blank');
    }
</script>