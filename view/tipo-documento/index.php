                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Tipo Documento
                                <a href="javascript::" onclick="carrega_pagina('tipo-documento','create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
                        <div class="box-content">
                            ...
                            <hr />
                            <div id="load_tipo_documento"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#load_tipo_documento").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_tipo_documento.php",
        ...
        columns: [
            {
                formatter: updateIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    carrega_pagina('tipo-documento', 'update.php?id='+data.tipo_documento_id);
                }
            },
            {title: "ID", field: "tipo_documento_id", sorter: "int", width: 200},
            {title: "Descrição", field: "tipo_documento_descricao", sorter: "string"},
            {title: "Status", field: "tipo_documento_status_view", sorter: "string"}
        ]
    });
    ...
    function search(){
        ...
        $.ajax({
            ...
            success: function () {
                load_out();
                $("#load_tipo_documento").tabulator("setData", "_controller/_tipo_documento.php?acao=load");
            }
        });
    }
</script>