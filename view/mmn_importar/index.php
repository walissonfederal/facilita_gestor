                    ...
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                ...
                                <a href="javascript::" onclick="carrega_pagina('mmn_importar', 'create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
...
<script>
    ...
    $("#load_disco_virtual_retorno").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_mmn_disco_virtual.php",
        ...
        columns: [
            {
                formatter: printIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    window.open('_reports/_tratar_retorno/report_mmn.php?id=' + data.baixa_retorno_id, '_blank');
                }
            },
			{
                formatter: viewIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    window.open('_controller/gerar_retorno_mmn.php?inicio=0&retorno=' + data.baixa_retorno_id, '_blank');
                }
            },
			{
	...
	function verify_arquivo(arquivo){
        ...
        $.ajax({
            type: 'GET',
            url: "_controller/_mmn_disco_virtual.php",
            data: acao,
            beforeSend: load_in(),
