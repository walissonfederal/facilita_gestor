                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Rota
                                <a href="javascript::" onclick="carrega_pagina('rota', 'index.php');" class="btn btn-primary">Voltar</a>
                            </h3>
                        </div>
                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="form-group col-lg-9">
                                            ...
                                            <input type="text" class="form-control rota_descricao" name="rota_descricao"/>
                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label>Status</label>
                                            <select class="form-control rota_status" name="rota_status">
