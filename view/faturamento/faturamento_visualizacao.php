...
include_once '../../_boleto_pdf/_mj_boleto_geracao/_fpdf/fpdf.php';
$limit = 0;
$id_faturamento = addslashes($_GET['identificador']);
//echo $_SESSION['login_boleto_online']['contato_id'];
...
$pdf->AddPage();
echo '<pre>';
var_dump($read_faturamento_view['contato_id']);
echo '</pre>';
//Select Arial bold 8
