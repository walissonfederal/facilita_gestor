                        ...
                        <div class="box-content">
                            <form action="" id="reverse">
                                <fieldset>
                                    ...
                                    <hr />
                                    <?php if(GetEmpresa('empresa_reverse_config') == '0'){?>
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Senha</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12" align="right">
                                            <button type="button" class="btn btn-primary" onclick="reverse();">Estornar</button>
...
<script>
    ...
    function reverse(){
        var dados = $("#reverse").serialize();
        var acao = "&acao=reverse&OP=<?=$_GET['OP'];?>&id=<?=$_GET['id'];?>";
    ...
    $(function(){
        var acao = "acao=load_update_reverse&id=<?=$_GET['id'];?>";
        $.ajax({
            type: 'POST',
            url: "_controller/_financeiro.php",
            data: acao,
