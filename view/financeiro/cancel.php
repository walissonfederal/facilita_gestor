                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Obs</label>
                                            <textarea disabled="" class="form-control financeiro_obs" cols="" rows=""></textarea>      
                                        </div>
                                    </div>
                                    <hr />
                                    <?php if(GetEmpresa('empresa_cancel_config') == '0'){?>
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Senha</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Motivo</label>
                                            <textarea class="form-control financeiro_obss" name="financeiro_obs" cols="" rows=""></textarea>      
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-12" align="right">
                                            <button type="button" class="btn btn-primary" onclick="cancel();">Confirmar Cancelamento</button>
...
<script>
    ...
    function set_valor(){
        ...
        if(financeiro_valor_pagamento >= financeiro_desconto){
    ...
    function cancel(){
        var dados = $("#cancel").serialize();
        var acao = "&acao=cancel&OP=<?=$_GET['OP'];?>&id=<?=$_GET['id'];?>";
