    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                load_out();
                var data_return = jQuery.parseJSON(data);
                $(".assinatura_id_contato").val(data_return[0].assinatura_id_contato);
                buscar_contato();
                $(".assinatura_data_criacao").val(data_return[0].assinatura_data_criacao);
                $(".assinatura_data_final").val(data_return[0].assinatura_data_final);
                $(".assinatura_dia").val(data_return[0].assinatura_dia);
                $(".assinatura_id_plano").val(data_return[0].assinatura_id_plano);
                $(".assinatura_lancamento_auto").val(data_return[0].assinatura_lancamento_auto);
            }
        });
    });
</script>