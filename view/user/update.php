...
<script>
    ...
    function update(){
        $('#update').ajaxForm({
            ...
            dataType: 'json',
            url: '_controller/_user.php?acao=update&id=<?=$_GET['id']?>',
            resetForm: false
        }).submit();
    }
    $(function(){
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".user_login").val(data_return[0].user_login);
                $(".user_email").val(data_return[0].user_email);
                $(".user_id_nivel").val(data_return[0].user_id_nivel);
                $(".user_status").val(data_return[0].user_status);
                $(".user_id_caixa").val(data_return[0].user_id_caixa);
                $(".user_tipo_tecnico").val(data_return[0].user_tipo_tecnico);
                $(".user_ticket").val(data_return[0].user_ticket);
                if(data_return[0].user_id_contato !== '0'){
                    $(".user_id_contato").val(data_return[0].user_id_contato);
                    buscar_contato();
                }
                $(".user_tipo_ticket").val(data_return[0].user_tipo_ticket);
                carregar = new Image();
                carregar.src = data_return['0'].user_foto;
                document.getElementById("imagem_user").innerHTML = "<img src=\""+ carregar.src + " \" width=50 />";
            }
        });
    });
