                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Orçamento
                                <a href="javascript::" onclick="carrega_pagina('orcamento', 'create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
...
<script>
    ...
    $("#load_orcamento_venda").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_orcamento.php",
        ...
        columns: [
            {
                formatter: updateIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    carrega_pagina('orcamento', 'update.php?id='+data.orcamento_venda_id);
                }
            },
            {
                formatter: printIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    window.open('view/orcamento/print.php?id=' + data.orcamento_venda_id, '_blank');
                }
            },
    ...
    function search(){
        ...
        $.ajax({
            ...
            success: function () {
                load_out();
                $("#load_orcamento_venda").tabulator("setData", "_controller/_orcamento.php?acao=load");
            }
        });
    }
</script>