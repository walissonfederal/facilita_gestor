                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Orçamento
                                <a href="javascript::" onclick="carrega_pagina('orcamento', 'index.php');" class="btn btn-primary">Voltar</a>
                            </h3>
                        </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12" align="right">
                                            ...
                                            <a href="javascript::" onclick="carrega_pagina('orcamento', 'index.php');" class="btn btn-danger">Cancelar</a>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
...
<script>
    ...
    function set_data_1(){
        ...
        $.ajax({
            type: 'POST',
            url: "_controller/_orcamento.php",
            data: acao,
            beforeSend: load_in(),
            success: function (data) {
                load_out();
    ...
    function fechar_modal(){
        ...
        $("#pagamento_venda_orcamento").modal('hide');
        $("#detalhe_venda_orcamento").modal('hide');
        carrega_pagina('orcamento', 'index.php');
    }
            ...
            success: function (data) {
                ...
                if(data_return.type === 'error'){
                    ...
                    if(data_return.valor_restante === '0.00'){
                        $("#load_button_create").html('<button type="button" class="btn btn-primary" onclick="create();">Gravar Orçamento (F10)</button>');
                    }else{
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(data_return.type === 'success'){
                            $(".forma_pagamento_valor").val(data_return.valor_restante);
                            if(data_return.valor_restante === '0.00'){
                                $("#load_button_create").html('<button type="button" class="btn btn-primary" onclick="create();">Gravar Orçamento</button>');
                            }else{
                                $("#load_button_create").html('');
                            }
                        }
