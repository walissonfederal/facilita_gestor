            ...
            success: function (data) {
                ...
                if(data_return.type === 'error'){
                    ...
                    if(data_return.valor_restante === '0.00'){
                        $("#load_button_create").html('<button type="button" class="btn btn-primary" onclick="update();">Gravar Orçamento (F10)</button>');
                    }else{
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(data_return.type === 'success'){
                            $(".forma_pagamento_valor").val(data_return.valor_restante);
                            if(data_return.valor_restante === '0.00'){
                                $("#load_button_create").html('<button type="button" class="btn btn-primary" onclick="update();">Gravar Orçamento</button>');
                            }else{
                                $("#load_button_create").html('');
                            }
                        }
