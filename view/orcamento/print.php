...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="20" colspan="4" align="center">
            <strong style="font-size:25px">OR&Ccedil;AMENTO <?php echo $uid;?></strong>
        </td>
    </tr>
    <tr>
...
<table width="750" border="0" align="center" cellpadding="2" cellspacing="2">
    ...
    <tr>
        <td height="20" colspan="8" align="left">
            <strong style="font-size:13px">DADOS DA ORÇAMENTO</strong>
        </td>
    </tr>
    <tr>
...
<table width="750" border="0" align="center" cellpadding="2" cellspacing="2">
    ...
    <tr>
        <td height="20" align="left"><strong>VALOR TOTAL DO OR&Ccedil;AMENTO</strong></td>
        <td height="20" colspan="2" align="left">
