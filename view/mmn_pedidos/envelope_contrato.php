<?php
    ...
    if(NumQuery($readContato) > '0'){
		...
		header("Location: ../mmn_user/contrato/index.php?id=".$readContatoView['user_id']."");
    }else{
...
<table width="" height="600" border="1" class="textoVerticalTable">
    ...
    <tr>
        <td><?php echo $readContatoView['user_endereco'];?></td>
        <td><?php echo $readContatoView['user_numero'];?></td>
        <td><?php echo $readContatoView['user_bairro'];?></td>
        <td><?php echo $readContatoView['user_complemento'];?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?php echo $readContatoView['user_cep'];?></td>
        <td><?php echo $readContatoView['user_uf'];?></td>
        <td colspan="2"><?php echo $readContatoView['user_cidade'];?></td>
    </tr>
</table>
