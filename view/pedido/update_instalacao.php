    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".pedido_id_plano").val(data_return[0].pedido_id_plano);
                $(".pedido_valor_plano").val(data_return[0].pedido_valor_plano);
                $(".pedido_valor_ativacao").val(data_return[0].pedido_valor_ativacao);
                $(".pedido_tipo_frete").val(data_return[0].pedido_tipo_frete);
                $(".pedido_valor_frete").val(data_return[0].pedido_valor_frete);
                $(".pedido_obs").val(data_return[0].pedido_obs);
                $(".pedido_id_associado").val(data_return[0].pedido_id_associado);
