                    ...
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                ...
                                <a href="javascript::" onclick="carrega_pagina('agendamento', 'create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
...
<script>
    ...
    $("#load_agendamento").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_agendamento.php",
        ...
        columns: [
            {
                formatter: updateIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    carrega_pagina('agendamento', 'update.php?id='+data.agendamento_id);
                }
            },
            {title: "ID", field: "agendamento_id", sorter: "int", width: 200},
            {title: "Descrição", field: "agendamento_descricao", sorter: "string"},
            {title: "Status", field: "agendamento_status_view", sorter: "string"}
        ]
    });
    ...
    function search(){
        ...
        $.ajax({
            type: 'GET',
            url: "_controller/_agendamento.php",
            data: acao,
            beforeSend: load_in(),
            success: function () {
                load_out();
                $("#load_agendamento").tabulator("setData", "_controller/_agendamento.php?acao=load");
            }
        });
    }
</script>