                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Forma Pagamento
                                <a href="javascript::" onclick="carrega_pagina('forma-pagamento', 'create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
                        <div class="box-content">
                            ...
                            <hr />
                            <div id="load_forma_pagamento"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#load_forma_pagamento").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_forma_pagamento.php",
        ...
        columns: [
            {
                formatter: updateIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    carrega_pagina('forma-pagamento', 'update.php?id='+data.forma_pagamento_id);
                }
            },
            {title: "ID", field: "forma_pagamento_id", sorter: "int", width: 200},
            {title: "Descrição", field: "forma_pagamento_descricao", sorter: "string"},
            {title: "Status", field: "forma_pagamento_status_view", sorter: "string"}
        ]
    });
    ...
    function search(){
        ...
        $.ajax({
            ...
            success: function () {
                load_out();
                $("#load_forma_pagamento").tabulator("setData", "_controller/_forma_pagamento.php?acao=load");
            }
        });
    }
</script>