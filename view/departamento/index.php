                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>
                                Departamento
                                <a href="javascript::" onclick="carrega_pagina('departamento', 'create.php');" class="btn btn-primary">Cadastrar Novo</a>
                            </h3>
                        </div>
...
<script>
    ...
    $("#load_departamento").tabulator({
        height: "350px",
        fitColumns: true,
        ajaxURL: "_controller/_departamento.php",
        ...
        columns: [
            {
                formatter: updateIcon, width: 40, align: "center", onClick: function (e, cell, val, data) {
                    carrega_pagina('departamento', 'update.php?id='+data.departamento_id);
                }
            },
            {title: "ID", field: "departamento_id", sorter: "int", width: 200},
            {title: "Descrição", field: "departamento_descricao", sorter: "string"},
            {title: "Status", field: "departamento_status_view", sorter: "string"}
        ]
    });
    ...
    function search(){
        ...
        $.ajax({
            ...
            success: function () {
                load_out();
                $("#load_departamento").tabulator("setData", "_controller/_departamento.php?acao=load");
            }
        });
    }
</script>