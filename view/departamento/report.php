                        ...
                        <div class="box-content">
                            <div class="row">
                                <div class="form-group col-lg-12" align="right">
                                    ...
                                    <a href="javascript::" onclick="carrega_pagina('departamento', 'index.php')" class="btn btn-danger">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function gerar_excel(){
        window.open('_controller/_departamento.php?acao=gerar_excel', '_blank');
    }
    function gerar_pdf(){
        window.open('_reports/_departamento/report.php', '_blank');
    }
</script>