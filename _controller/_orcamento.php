...
if($acao == 'load'){
    ...
    $read_orcamento_venda_paginator = ReadComposta("SELECT orcamento_venda_id, orcamento_venda_tipo FROM orcamento_venda WHERE orcamento_venda_tipo = '0' {$_SESSION['orcamento_venda_load_']}");
    $read_orcamento_venda = Read('orcamento_venda', "WHERE orcamento_venda_tipo = '0' {$_SESSION['orcamento_venda_load_']} ".$order_by." LIMIT $inicio,$maximo");
    ...
    if($orcamento_venda_form['orcamento_venda_id_contato'] == ''){
        ...
        $orcamento_venda_form['orcamento_venda_tipo'] = '0';
        ...
        $json_orcamento_venda = array(
            ...
            'buttons' => '<a href="view/orcamento/print.php?id='.$id_orcamento_venda.'" class="btn btn-default" target="_blank">Imprimir</a><a href="javascript::" onclick="fechar_modal();" data-dismiss="modal" class="btn btn-primary">Sair</a>'
        );
    }
