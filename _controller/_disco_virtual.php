...
if($acao == 'load_spc'){
	...
	if(NumQuery($read_retorno) > '0'):
		$read_retorno_completo = ReadComposta("SELECT baixa_id, financeiro_id FROM baixa INNER JOIN financeiro ON financeiro_nosso_numero = baixa_nosso_numero WHERE financeiro_status = '0' AND baixa_id_baixa_retorno = '".$arquivo."'");
